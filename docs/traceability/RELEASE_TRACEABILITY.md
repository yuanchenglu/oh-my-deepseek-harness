...
| `REL-002` | `develop` 集成、`master` 发布、PR 模板、Ruleset 与默认分支 | 文档冲突搜索 + repository settings verification | #7 | #8 (Part A) | 待合入 | [`REL-002.md`](../testing/evidence/REL-002.md) | Blocked: external settings |
