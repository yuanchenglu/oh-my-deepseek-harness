...
| `REL-004` | 目标 10 Tool 名称、当前 9 Tool Runtime 与 pending 迁移状态 | `TestToolContract` + 9 Tool registration tests | #10 | #11 | 待合入 | [`REL-004.md`](../testing/evidence/REL-004.md) | In Review |
